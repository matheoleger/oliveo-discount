...
export const ProductCard = ({product}:{product: Product}) => {
    return (
        <Box backgroundColor={"white"} borderRadius={10} border={"1px solid #e1e1e1"} boxShadow='xl' padding={5} maxWidth={330} maxHeight={470} _hover={{boxShadow:'2xl', cursor: "pointer"}}>
